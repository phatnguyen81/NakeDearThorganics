...
namespace Nop.Plugin.Widgets.Camera.Controllers
{
    public class WidgetsCameraController : BasePluginController
    {
        ...
        public ActionResult Configure()
        {
            ...
            var nivoSliderSettings = _settingService.LoadSetting<CameraSettings>(storeScope);
        ...
        {
            var nivoSliderSettings = _settingService.LoadSetting<CameraSettings>(_storeContext.CurrentStore.Id);
